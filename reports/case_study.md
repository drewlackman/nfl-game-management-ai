...
1) Patriots vs Colts (Week 10, 2009) — 4th & 2 at own 28, 2:08 Q4, up 6  
   ...
   - Model rec: [fill] — WP [fill]%  
   - Delta vs actual: [fill] pp  
...
- App screenshot: add a Streamlit screenshot here: `![](../outputs/screenshots/streamlit.png)`

## Aggregated Results (fill after running scenarios)
- Matches vs actual decisions: [fill] / [total]
- Average WP delta (model vs actual): [fill] pp
- Biggest positive delta: [fill] (game, situation)
- Biggest negative delta: [fill] (game, situation)
